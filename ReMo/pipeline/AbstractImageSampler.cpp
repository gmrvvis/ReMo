...
namespace remo
{
					...
					std::uint8_t & b)
	{
			...
			topR = srcBuffer[0][topIndex + 2]; topG = srcBuffer[0][topIndex + 1]; topB = srcBuffer[0][topIndex];
			botR = srcBuffer[0][botIndex + 2]; botG = srcBuffer[0][botIndex + 1]; botB = srcBuffer[0][botIndex];
			lefR = srcBuffer[0][lefIndex + 2]; lefG = srcBuffer[0][lefIndex + 1]; lefB = srcBuffer[0][lefIndex];
			rigR = srcBuffer[0][topIndex + 2]; rigG = srcBuffer[0][rigIndex + 1]; rigB = srcBuffer[0][rigIndex];
			cenR = srcBuffer[0][topIndex + 2]; cenG = srcBuffer[0][cenIndex + 1]; cenB = srcBuffer[0][cenIndex];
